...
/**
 * @fileOverview Implementa el patrón RUP ProgressBar.
 * @author EJIE
 * @version 2.5.0
 */
 ;(function( factory ) {
    ...
    * @namespace jQuery.rup_progressbar
    * @memberOf jQuery
    * @tutorial rup_progressbar
    * @example
		* var properties = {
		*		value: 50
		*	};
    ...
    */
	...
	$.fn.rup_progressbar("extend",{
		...
		*
		* @name jQuery.rup_progressbar#getRupValue
		* @function
...
el resto de componentes RUP para estandarizar la asignación del valor a la barra de progreso.
		 *
		 * @name jQuery.rup_progressbar#setRupValue
		 * @function
     ...
     *
     * @name jQuery.rup_progressbar#destroy
     * @function
		 * @return {jQuery} - Retorna la referencia al elemento.
     * @example
     ...
     *
     * @name jQuery.rup_progressbar#disable
     * @function
		 * @return {jQuery} - Retorna la referencia al elemento.
     * @example
     ...
     *
     * @name jQuery.rup_progressbar#enable
     * @function
		 * @return {jQuery} - Retorna la referencia al elemento.
     * @example
     ...
     *
     * @name jQuery.rup_progressbar#instance
     * @function
     ...
     *
     * @name jQuery.rup_progressbar#option
     * @function
     ...
     *
     * @name jQuery.rup_progressbar#value
     * @function
     ...
     *
     * @name jQuery.rup_progressbar#widget
     * @function
	...
	$.fn.rup_progressbar("extend", {
		_init : function(args){
			var $self = this, settings = $.extend({}, $.fn.rup_progressbar.defaults, args[0]);
	 ...
	 *
	 * @name jQuery.rup_progressbar#defaults
