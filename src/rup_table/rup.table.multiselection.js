...
(function ($) {
    ...
    jQuery.fn.rup_table("extend", {
         ...
         * @function
         * @name getSelectedIds
         * @return {array} identificadores de los registros seleccionados.
         * @example
         ...
         * @function
         * @name clearHighlightedEditableRows
         * @example
         ...
         * @function
         * @name  highlightFirstEditableRow
         * @example
         ...
         * @function
         * @name highlightEditableRow
         * @param  {object} $row - La fila a resaltar
         * @example
     ...
     * @name options
     * @property {boolean} 	headerContextMenu_enabled -  Habilita el menú contextual que se muestra en el check de multiselección en la cabecera de la tabla
     * @property {object} headerContextMenu - Propiedades de configuración del menú contextual de la cabecera de la tabla.
     * @property {boolean} rowContextMenu_enabled - Habilita el menú contextual que se muestra en los checks correspondientes a cada registro.
     * @property {object} rowContextMenu - : Propiedades de configuración de los menús contextuales asociados a cada registro.
     */
     ...
     * @event module:rup_table/multiselection#rupTable_multiselectionUpdated
     ...
     * @event module:rup_table/multiselection#rupTableSelectedRowNumberUpdated
     * @property {Event} e - Objeto Event correspondiente al evento disparado.
     * @example
