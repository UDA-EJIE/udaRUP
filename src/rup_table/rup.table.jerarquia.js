...
(function (jQuery) {
     ...
     * @name options
     * @property {string} [token=/] - Carácter separador utilizado para concatenar diferentes identificadores de los registros mostrados en la jerarquía.
     * @property {string} icons - 	plus: Icono para expandir el nodo.	minus: Icono para contraer el nodo. leaf: Icono correspondiente a un nodo hoja. filter: Icono para indicar que el nodo satisface los parámetros de filtrado
     * @property {boolean} parentNodesTooltip - Determina si se debe de mostrar un tooltip para cada nodo, en el cual se representa la jerarquía que ocupa respecto a los padres.
     * @property {function} parentNodesTooltipFnc -  Función de callback que permite personalizar el tooltip a mostrar.
     * @property {boolean} 	contextMenu - Determina si se muestra el menú contextual para cada nodo.
     */
