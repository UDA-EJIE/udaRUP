...
(function ($) {
    ...
    jQuery.fn.rup_table("extend", {
            ...
            if (settings.inlineEdit.autoEditRow) {
                $self.on({
                    "jqGridCellSelect.rupTable.inlineEditing": function (event, rowid, iCol, cellcontent, obj) {
                        ...
                        if (iCol !== -1) {
                            $self.on(
                                "jqGridInlineEditRow.rupTable.inlineEditing.cellSelected",
                                function (event, rowId) {
        ...
        postConfigureInlineEdit: function (settings) {
            var $self = this,
                formId = "inlineForm_" + settings.id,
                $inlineForm = $("<form>").attr({
                    "id": "inlineForm_" + settings.id
                });
    ...
    jQuery.fn.rup_table("extend", {
        ...
        addRow: function (options) {
             ...
             */
            var auxOptions = {
                addRowParams: $.extend({}, settings.inlineEdit.addOptions, options)
            };
         ...
         * @param  {boolean} skipFieldCheck -  Si está activado, controla los campos editables en modo edición
         * @example
         ...
         * @param  {object} options - Opciones de configuración de la acción de guaradado.
         * @example
     ...
     * @event module:rup_table/inlineEdit#rupTable_deleteAfterSubmit
     ...
     * @event module:rup_table/inlineEdit#rupTableAfterDelete
     * @property {Event} e - Objeto Event correspondiente al evento disparado.
