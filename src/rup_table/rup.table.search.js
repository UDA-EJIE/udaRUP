            ...
            $self.on({
                ...
                "rupTable_searchAfterCreateToolbar": function (event, $searchRow) {
                    var props = $self[0].p,
                        ...
                        cellColModel, $elem, editOptions, searchRupType, searchEditOptions;
                    ...
                    $("th[role='columnheader']", $searchRow).each(function (i) {
                        ...
                        if (searchRupType !== undefined) {
                            ...
                            case "combo":
                                searchEditOptions = $.extend({}, {
                                    menuWidth: $elem.width()
                                }, searchEditOptions, {
                                    width: "97%"
                                });
                                break;
    ...
    jQuery.fn.rup_table("extend", {
        ...
        createSearchToolbar: function () {
            ...
            $.each(prop.colModel, function (index, colM) {
                ...
                soptions = $.extend({}, colM.searchoptions || colM.editoptions || {}, {
                    id: colM.name,
                    name: colM.name
                });
                if (colM.search) {
         ...
         * @param  {object} settings - Opciones de configuración indicadas en la incialización del componente
         * @example
         ...
         * @name navigateToMatchedRow
         * @param  {number} matchedRow - Línea a la cual se quiere navegar.
         * @example
         * $("#idComponente").rup_table("navigateToMatchedRow", matchedRow);
         */
        navigateToMatchedRow: function (matchedRow) {
            var $self = this,
                retNavParams = $self.rup_table("fncGetSearchNavigationParams", matchedRow);
         ...
         * @name goToFirstMatched
         * @param  {number} paramPage - En caso de indicarse una página se utilizará en vez de la página actual.
         * @example
        ...
        doSearchNavigation: function (arrParams, execute, changePage, index, npos, newPage, newPageIndex) {
            var $self = this,
                settings = $self.data("settings"),
                execute, changePage, index, newPage, newPageIndex, indexAux, ret, actualRowId, rowId;
         ...
         * @name clearHighlightedMatchedRows
         * @example
         ...
         * @name highlightMatchedRowsInPage
         * @example
         ...
         * @name highlightMatchedRow
         * @param  {object} $row - Objeto jQuery que referencia la línea de la tabla que se quiere resaltar.
         * @example
         ...
         * @name updateSearchPagination
         * @param  {number} paramRowId - Numero de fila
    ...
    jQuery.fn.rup_table("extend", {
        ...
        _processMatchedRow: function (settings, matchedElem) {
            ...
            if (jQuery.inArray(matchedElem.id, settings.search.matchedIds) === -1) {
                ...
                settings.search.matchedRows.push({
                    id: matchedElem.id,
                    page: matchedElem.page
                });
