...
(function ($) {
        ...
        .rup_table(
            "extend", {
                ...
                preConfigureMultifilter: function (settings) {
                    var $self = this,
                        tableId = settings.id,
                        multifilterSettings = settings.multifilter,
                        dropdownDialogId, $dropdownDialog, $dropdownDiaglogTemplate;
                ...
                postConfigureMultifilter: function (settings) {
                    var $self = this,
                        multifilterSettings = settings.multifilter,
                        filterSettings, $dropdownButton, $combo, $comboLabel, $defaultCheck, $feedback, $comboButton, $closeDialog;
    ...
    jQuery.fn
        .rup_table(
            "extend", {
                 ...
                 * @function
                 * @name addFilter
                 * @param  {object} filter - Objeto filtro a añadir
                 * @example
                 ...
                 * @function
                 * @name deleteFilter
                 * @param  {object} filter - Objecto filtro a eliminar
                 * @example
            ...
            "extend", {
                ...
                _configCombo: function (settings) {
                    ...
                    multifilterSettings.$comboLabel.on("blur", function (event) {
                        ...
                        // desplegado
                        var selected =
                            multifilterSettings.$combo.data("selected"),
     ...
     * @property {number} labelSize - Permite especificar el tamaño máximo permitido para el nombre del filtro. Es una propiedad obligatoria.
     ...
     * @property {booelan} [getDefatult=true]  - Determina si el multifiltro debe de cargar el filtro por defecto al cargar la página
     *
     */
     ...
     * @event module:rup_table/multifilter#rupTable_multifilter_beforeAdd
     ...
     * @event module:rup_table/multifilter#rupTable_multifilter_fillForm
     * @property {Event} e - Objeto Event correspondiente al evento disparado.
     * @example
