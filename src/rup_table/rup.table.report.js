...
(function ($) {
     ...
     * @name options
     * @property {array} columns - Permite especificar mediante un array, los identificadores de las columnas que van a ser mostradas en el informe.
     * @property {object} 	buttons - Esta propiedad permite especificar los controles mediante los cuales se van a exportar los datos en los diferentes formatos.
     *
     */
     ...
     * @event module:rup_table/report#rupTable_serializeReportData
