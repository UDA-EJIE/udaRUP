...
( function(root, factory ) {
 if ( typeof define === "function" && define.amd ) {
  ...
  ToolbarJQueryUIAdapter.prototype.addButton = function (obj, json_i18n) {
    ...
    var boton = $(Rup.Templates.rup.toolbar.button.jqueryui({
      id: buttonId,
      css: obj.css,
      label: $.rup.i18nParse(json_i18n,obj.i18nCaption)
    }));
