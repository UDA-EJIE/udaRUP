...
/**
 * @fileOverview Implementa el patrón RUP Slider.
 * @author EJIE
 * @version 2.5.0
 */
 ;(function( factory ) {
	...
	$.fn.rup_slider("extend",{
		...
		*
		* @name jQuery.rup_slider#getRupValue
		* @function
		...
		*/
		 ...
		 *
		 * @name jQuery.rup_slider#setRupValue
		 * @function
     ...
     *
     * @name jQuery.rup_slider#destroy
     * @function
		 * @return {jQuery} - Retorna la referencia al elemento.
     * @example
     ...
     *
     * @name jQuery.rup_slider#disable
     * @function
		 * @return {jQuery} - Retorna la referencia al elemento.
     * @example
     ...
     *
     * @name jQuery.rup_slider#instance
     * @function
