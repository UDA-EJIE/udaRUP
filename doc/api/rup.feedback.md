...
**Kind**: event emitted by <code>[rup_feedback](#module_rup_feedback)</code>  
**Example**  
```js
...
**Kind**: inner property of <code>[rup_feedback](#module_rup_feedback)</code>  
**Properties**
...
**Kind**: inner method of <code>[rup_feedback](#module_rup_feedback)</code>  
**Example**  
```js
...
**Kind**: inner method of <code>[rup_feedback](#module_rup_feedback)</code>  
**Emits**: <code>[rupFeedback_show](#module_rup_feedback+event_rupFeedback_show)</code>  
**Example**  
```js
