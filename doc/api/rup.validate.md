...
**Kind**: event emitted by [<code>rup\_validate</code>](#module_rup_validate)  
**Properties**
...
**Kind**: inner property of [<code>rup\_validate</code>](#module_rup_validate)  
...
**Kind**: inner typedef of [<code>rup\_validate</code>](#module_rup_validate)  
