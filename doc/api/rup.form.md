...
**Kind**: inner property of <code>[rup_form](#module_rup_form)</code>  
**Properties**

| Name | Type | Default | Description |
| --- | --- | --- | --- |
| beforeSerialize | <code>[beforeSerialize](#jQuery.rup_form..beforeSerialize)</code> | <code></code> | Función de callback que será invocada antes de realizarse la serialización del formulario. Permite la modificación de los datos del formulario antes de que estos sean recuperados para su procesado por el componente. |
| beforeSubmit | <code>[beforeSubmit](#jQuery.rup_form..beforeSubmit)</code> | <code></code> | Función de callback que será invocada antes de realizarse el envío del formulario. Permite acceder a la información que será enviada al formulario. En caso de retornar false no se realizará en envío. |
...
| error | <code>[error](#jQuery.rup_form..error)</code> |  | Función de callback que será invocada cuando se produzca un error. |
...
| suceess | <code>[suceess](#jQuery.rup_form..suceess)</code> |  | Método callback que será invocado cuando se reciba la respuesta del formulario. |
