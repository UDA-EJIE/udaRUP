...
module.exports = function (config) {
    config.set({
        ...
        htmlReporter: {
            ...
            pageTitle: 'Karma Report 4.5.2', // page title for reports; browser info by default
            urlFriendlyName: false, // simply replaces spaces with _ for files/dirs
            reportName: 'karma_report_4.5.2', // report summary filename; browser info by default
