...
module.exports = function (config) {
    config.set({
        ...
        htmlReporter: {
            ...
            pageTitle: 'Karma Report 4.2.0', // page title for reports; browser info by default
            urlFriendlyName: false, // simply replaces spaces with _ for files/dirs
            reportName: 'karma_report_4.2.0', // report summary filename; browser info by default
