...
App.Views.WizardDinamico = Backbone.View.extend({
    el: '#container',
    render: renderWizardDinamicoView
});



function renderWizardDinamicoView(){
    
    var template = App.Templates["app/components/wizard/wizardDinamico.hbs"];
