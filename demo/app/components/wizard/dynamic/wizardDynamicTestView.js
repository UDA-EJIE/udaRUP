define(['marionette',
	'./wizardDynamicTestTemplate.hbs',
	'rup.wizard','rup.button'], function(Marionette, WizardDynamicTestTemplate){

	var WizardDynamicTestView = Marionette.View.extend({
		template: WizardDynamicTestTemplate,
