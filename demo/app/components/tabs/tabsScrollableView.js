...
App.Views.TabsScrollable = Backbone.View.extend({
    el: '#container',
    render: renderTabsScrollableView,
});



function renderTabsScrollableView(){
    
    var template = App.Templates["app/components/tabs/tabsScrollable.hbs"];
