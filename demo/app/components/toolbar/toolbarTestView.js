...
define(['marionette',
    ...
    function fncOnAttach(){
        ...
        this.ui.toolbar.rup_toolbar({
            ...
            buttons:[
                {i18nCaption:'buscar', css:'mdi mdi-magnify', click: handlerBoton , disabled: true},
                {id: 'mbuton1', i18nCaption:'otros', buttons:[
                    {i18nCaption:'nuevo', css:'mdi mdi-file', click: handlerMButtons},
                    {i18nCaption:'editar', css:'mdi mdi-square-edit-outline', click: handlerMButtons, disabled: true},
